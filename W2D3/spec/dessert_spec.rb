...
describe Dessert do
  let(:chef) { double("chef", name: "T") }
  let(:cake) { Dessert.new("cake", 10, "T")}
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do 
    	expect {Dessert.new("cake", "ten", "T")}.to raise_error(ArgumentError)
    end 
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
    	expect(cake.serve).to eq("T has made 10 cakes!")
    end 
  end
